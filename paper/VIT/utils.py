...
def get_model(args):
    ...
    elif args.model_name == 'encoder_vit':
    ...
    elif args.model_name == 'memory_vit':
        from vit import MemoryViT
        net = MemoryViT(
            args.in_c, 
            args.num_classes, 
            img_size=args.size, 
...
def get_transform(args):
    ...
    if args.autoaugment:
        if args.dataset == 'c10' or args.dataset=='c100' or args.dataset=='cinic':
...
def get_dataset(args):
    ...
    if args.dataset == "cinic":
        ...
        train_ds = torchvision.datasets.ImageFolder(root + "/CINIC10" + '/train', transform=train_transform)
        test_ds = torchvision.datasets.ImageFolder(root + "/CINIC10" + '/test', transform=test_transform)
