...
class MemoryShuffleNetV2(nn.Module):
    def __init__(self, net_size):
        super(MemoryShuffleNetV2, self).__init__()
...
class EncoderMemoryShuffleNetV2(nn.Module):
    def __init__(self, net_size):
        super(EncoderMemoryShuffleNetV2, self).__init__()
        out_channels = configs[net_size]['out_channels']
        num_blocks = configs[net_size]['num_blocks']
    ...
    def forward(self, x, ss, return_weights=False):
        ...
        # prediction
        out_mw, x = self.mw(out, out_ss, return_weights)
        return out_mw, x
