...
def get_SVHN(data_dir:str, batch_size_train:int, batch_size_test:int,batch_size_memory:int,size_train:int=100000,seed:int=42)->List[torch.utils.data.DataLoader]:
